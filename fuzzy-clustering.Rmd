...
subtitle: "Klasifikasi Mood Lagu Berdasarkan Data Spotify"
author: "Inayatus"
date: "4/28/2020"
output: 
  html_document:
...
```{r}
spotify <- read.csv("data_input/SpotifyFeatures.csv", encoding = "UTF-8") %>% 
...
```{r, fig.cap='[Thayer’s mood model](https://sites.tufts.edu/eeseniordesignhandbook/2015/music-mood-classification/)', fig.align='center', echo=FALSE, fig.width=50}
knitr::include_graphics("assets/mood-classification.jpg")
```
